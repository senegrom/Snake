...
The narrow-layout checks use a 1024×768 display at 200% scaling and assert that the logical screen really is 512×384. Install Xvfb, Openbox and x11-utils to run the managed-desktop checks locally:
